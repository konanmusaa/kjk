...
try:
	...
	carrier = '' + random.choice(['02', 'Oramge', 'EE', "At&", "MTN", "Cricket","Zain"])
...
def login_lagi334():
	try:
		...
		os.system('clear')
		cookie=input(f'  [{h}•{x}]حط الكوكيز ❤ :{asu} ')
...
def menu(id):
	...
	table.add_row("02","𝐅𝐑𝐈𝐄𝐍𝐃𝐒  :√ من اصدقاء ","🟢")
...
def follower():
    ...
    for userr in uid:
        try:
            ...
            print('[✘] ايدي مو ظاهر متابعينو جيب غيرو')
            time.sleep(3)
            follower()
